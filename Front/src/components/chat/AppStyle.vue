...
export default {
  ...
  computed: {
    style() {
      ...
      const { colorScheme, textColor, boardContentBg, bubbleBtnSize, botAvatarImg, botAvatarSize, inputDisableBg, msgBubbleBgBot, msgBubbleColorBot, msgBubbleBgUser, msgBubbleColorUser } =
        this.options;
      const styles = `
